...
val hwnd_desktop : hwnd
val hwnd_topmost : hwnd
...
val access_mask_of_rights : access_right list -> access_mask

val access_mask_of_specific_rights :
    specific_func:('a -> access_mask) ->
    rights:access_right list * 'a list ->
    access_mask
...
val default_security_attributes : security_attributes
...
val make_overlapped_with_event : event:handle -> overlapped
...
val style_of_options : style_option list -> style

val special_style_of_options :
    special_func:('a -> style) ->
    options:style_option list * 'a list ->
    style
...
val fw_dontcare : int
val fw_thin : int
val fw_extralight : int
val fw_light : int
val fw_normal : int
val fw_medium : int
val fw_semibold : int
val fw_bold : int
val fw_extrabold : int
val fw_heavy : int

val default_logfont : logfont
...
val default_text_alignment : text_alignment
...
val edge_type_bump : edge_type
val edge_type_etched : edge_type
val edge_type_raised : edge_type
val edge_type_sunken : edge_type
...
val default_set_menu_item_info : set_menu_item_info
...
val default_set_scroll_info : set_scroll_info
...
val default_startupinfo : startupinfo
...
val default_create_process_params : create_process_params
...
val wm_user : message_id
val wm_app : message_id
...
val pack_simple_message : id:message_id -> message_contents
...
val null_message_processor : message_processor

val sequence_message_processors :
    message_processor -> message_processor -> message_processor

val combine_message_processors : message_processor list -> message_processor
...
val message_not_handled : 'a message_handler_result
val message_handled : unit message_handler_result
val message_return : 'a -> 'a message_handler_result
val message_return_raw : message_result -> 'a message_handler_result
...
val on_message :
    id:message_id ->
    deliver:('a, 'b) message_deliverer ->
    return:'b message_returner ->
    'a ->
    message_processor
...
val deliver_plain_message : ('a plain_message_handler, 'a) message_deliverer

type simple_message_handler = unit plain_message_handler
val return_simple_message : unit message_returner
val on_simple_message :
    id:message_id -> simple_message_handler -> message_processor

type general_message_handler = message_result plain_message_handler
val return_general_message : message_result message_returner
val on_general_message :
    id:message_id -> general_message_handler -> message_processor

val on_user_message :
  num:int -> general_message_handler -> message_processor
val on_app_message :
  num:int -> general_message_handler -> message_processor
...
val deliver_mouse_message : (mouse_message_handler, unit) message_deliverer
val on_mouse_message :
    id:message_id -> mouse_message_handler -> message_processor
...
type mouse_nc_message_handler =
    ...
    pt:point ->
    unit message_handler_result
val deliver_mouse_nc_message : (mouse_nc_message_handler, unit) message_deliverer
val on_mouse_nc_message :
    id:message_id -> mouse_nc_message_handler -> message_processor
...
type char_message_handler =
    ...
    data:key_data ->
    unit message_handler_result
val deliver_char_message : (char_message_handler, unit) message_deliverer
val on_char_message :
    id:message_id -> char_message_handler -> message_processor
...
type key_message_handler =
    ...
    data:key_data ->
    unit message_handler_result
val deliver_key_message : (key_message_handler, unit) message_deliverer
val on_key_message :
    id:message_id -> key_message_handler -> message_processor
...
val deliver_ctlcolor_message : (ctlcolor_message_handler, hbrush) message_deliverer
val return_ctlcolor_message : hbrush message_returner
val on_ctlcolor_message :
    id:message_id -> ctlcolor_message_handler -> message_processor
...
val explicit_dialog_returns : message_id list ref

val add_explicit_dialog_return : id:message_id -> unit
...
val the_instance : hinstance
val the_command_line : string
val the_show_command : show_window_option
