class sql.Connection {
	...
	static var init = Std.neko('
		var lib = Sql.lib.@s;
		sql_select_db = $loader.loadprim(lib+"@select_db",2);
		sql_request = $loader.loadprim(lib+"@request",2);
		sql_close = $loader.loadprim(lib+"@close",1);
		sql_escape = $loader.loadprim(lib+"@escape",2);
	');
