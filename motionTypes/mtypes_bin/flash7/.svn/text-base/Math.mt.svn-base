native class Math
{
	static public var LN10 : float;
	static public var LN2 : float;
	static public var LOG10E : float;
	static public var LOG2E : float;
	static public var PI : float;
	static public var SQRT1_2 : float;
	static public var SQRT2 : float;
