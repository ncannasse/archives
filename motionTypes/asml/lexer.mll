...
let keywords =
	...
	List.iter (fun k -> Hashtbl.add h (s_keyword k) k) 
		[Function;Class;Private;Public;Static;Var;New;If;Else;While;Do;For;
...
let get_error_pos printer p =
	let lines = List.rev (Hashtbl.find all_lines p.pfile) in
