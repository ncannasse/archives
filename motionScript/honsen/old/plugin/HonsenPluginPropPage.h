...
// HonsenPluginPropPage.h : déclaration de la classe de page de propriétés CHonsenPluginPropPage.


// CHonsenPluginPropPage : consultez HonsenPluginPropPage.cpp pour l'implémentation.
